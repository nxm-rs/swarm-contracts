...
contract SimpleSwapFactory {
     ...
     */
    function deploySimpleSwap(address issuer, uint256 defaultHardDepositTimeoutDuration, bytes32 salt)
        public
        returns (address)
    {
        address contractAddress = LibClone.cloneDeterministic(master, keccak256(abi.encode(msg.sender, salt)));
